    ...
    <div class="container m-auto">
        ...
        <div class="flex flex-wrap justify-center">
            ...
            <div class="lg:w-[500px] w-[350px] relative mx-10 my-10 overflow-hidden ">
                ...
                <div
                class="w-full bg-black/80 backdrop-blur-sm px-2 flex justify-between flex-row items-center flex-nowrap py-1 pb-3 absolute bottom-0 rounded-b-lg shadow-[0_-4px_10px_black]">
                    <div class="h-full">
